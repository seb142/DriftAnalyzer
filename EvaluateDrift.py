...
def evaluate(w,fx_to_fy,noise):
    ...
    for i in range(1,11):
        print('iteration:', i)
        os.system('java -cp moa.jar -javaagent:sizeofag-1.0.0.jar moa.DoTask "EvaluatePrequential -l (drift.SingleClassifierDrift -d DDM) -s (ArffFileStream -f /home/sebastian/PythonProjects/NoiseMaker/dataset/ClassNoise/gradual/%snoise/GradualW%s%sNoise%sN%s.arff) -i 80000 -f 1 -d /home/sebastian/PythonProjects/NoiseMaker/Evaluations/GradualW%s%sNoise%sN%s.csv"'%(fx_to_fy,w,fx_to_fy,noise,i,w,fx_to_fy,noise,i))

evaluate(1000,'F1F2',0.5)
evaluate(1000,'F1F2',1)
evaluate(1000,'F1F2',1.5)
evaluate(3000,'F1F2',0.5)
evaluate(3000,'F1F2',1)
evaluate(3000,'F1F2',1.5)

evaluate(1000,'F3F10',0.5)
evaluate(1000,'F3F10',1)
evaluate(1000,'F3F10',1.5)
